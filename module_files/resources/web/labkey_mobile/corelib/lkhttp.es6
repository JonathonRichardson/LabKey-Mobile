...
var registerPromiseWaitingForLogin = function(promise) {
...
var updateRows = function(schema, query, rows) { return makeAPIRequest('update', schema, query, rows) };
var deleteRows = function(schema, query, rows) { return makeAPIRequest('delete', schema, query, rows) };
var insertRows = function(schema, query, rows) { return makeAPIRequest('insert', schema, query, rows) };
...
export {
    ...
    login,
    registerPromiseWaitingForLogin,
    selectRows,
    updateRows,
    deleteRows,
    insertRows,
